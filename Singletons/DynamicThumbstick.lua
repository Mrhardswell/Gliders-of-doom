...
local joystickPositionValue = Instance.new("Vector3Value")
joystickPositionValue.Name = "JoystickPosition"
joystickPositionValue.Parent = Players.LocalPlayer
	...
	local function inputChanged(inputObject: InputObject)
		if inputObject == self.moveTouchObject then
			if self.moveTouchFirstChanged then
                ...
                joystickPositionValue.Value = Vector3.new(startPosVec2.X, startPosVec2.Y, 0)
            ...
            joystickPositionValue.Value = Vector3.new(inputObject.Position.X, inputObject.Position.Y, 0)
